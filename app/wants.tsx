...
const WantsScreen = () => {
  ...
  const [selectedTab, setSelectedTab] = useState("Wants");
  ...
  const categories = [
    { label: "Entertainment", icon: require("../assets/icons/Entertainment.png") },
    { label: "Food", icon: require("../assets/icons/Food.png") },
    { label: "Shopping", icon: require("../assets/icons/Shopping.png") },
    { label: "Travel", icon: require("../assets/icons/Travel.png") },
    { label: "Subscription", icon: require("../assets/icons/Subscription.png") },
    { label: "Donation", icon: require("../assets/icons/Donation.png") },
    { label: "Personal Care", icon: require("../assets/icons/Personal Care.png") },
